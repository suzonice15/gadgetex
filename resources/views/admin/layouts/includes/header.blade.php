...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="{{ asset('backed/adminfile')}}/bower_components/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('backed/adminfile')}}/bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('backed/adminfile')}}/bower_components/Ionicons/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('backed/adminfile')}}/plugins/timepicker/bootstrap-timepicker.min.css">
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ asset('backed/adminfile')}}/plugins/select2/select2.min.css">
    <link rel="stylesheet" href="{{ asset('backed/adminfile')}}/bower_components/bootstrap-daterangepicker/daterangepicker.css">
    <!-- bootstrap datepicker -->
    <link rel="stylesheet" href="{{ asset('backed/adminfile')}}/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    ...
    <link rel="stylesheet" href="{{ asset('backed/adminfile')}}/dist/css/skins/_all-skins.min.css">
