<div class="container-fluid footer-desktop p-5">
    <div class="row">
        <div class="col-lg-6 col-xl-6">
            <img style="height: 61px;" src="{{url('/')}}/images/Icon/logo.svg" class="img-fluid">
            ...
            <div class="d-flex flex-row">
                Connect with us |   <img src="{{url('/')}}/images/Icon/facebook.png"   class="img-fluid  "/>
                <img src="{{url('/')}}/images/Icon/youtube.png"   class="img-fluid  "/>
                <img src="{{url('/')}}/images/Icon/whatsapp.png"   class="img-fluid "/>
                <img src="{{url('/')}}/images/Icon/imo.png"  class="img-fluid  "/>
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12 d-flex flex-row justify-content-center" style="background-color:#ddd;border-radius: 10px">
            ...
            <img src="{{url('/')}}/images/Icon/Member of eCab.png" style="height: 32px;margin-top: 2px;margin-left: 9px;" class="img-fluid">
        ...
        <div class="col-lg-12 col-xl-12 d-flex flex-row justify-content-center"  style="border: 2px solid #ddd;margin-top: 12px;border-radius: 10px;">
            ...
            <img src="{{url('/')}}/images/Icon/Payment Partner-01 1.png"   class="img-fluid">
...
<div class="container-fluid">
    <img src="{{url('')}}/images/Icon/Capture 21.png" class="img-fluid " style="float: left;background: #ddd;/*! margin-right: 7px; */padding: 2px;margin-top: 42px;border-top-right-radius: 42px;margin-left: -11px;height: 82px;">

    <img src="{{url('')}}/images/Icon/Messenger 8.png" class="img-fluid " style="float: right;background: #ddd;margin-right: -12px;padding: 12px;margin-top: 50px;border-top-left-radius: 43px;width: 103px;">
