...
<div class="container-fluid fmbfooter mt-3">
    <div class="row">
        <div class="col-2" style="max-width: 100%; height: auto;background:#ddd;border-top-left-radius: 30px;">
          <a href="{{url('/')}}/takeguide">  <img style="padding-top: 8px;" src="{{asset('/images/ICON/Capture-4.png')}}" class="img-fluid "  ></a>
        ...
        <div class="col-2" style="background:#ddd;border-top-right-radius: 30px;">
           <a href="https://business.facebook.com/latest/inbox/messenger?asset_id=111812157937774&nav_ref=diode_page_inbox&mailbox_id=&selected_item_id=100006945403351"> <img src="{{asset('/images/ICON/msg.png')}}" class="img-fluid "  style="padding-top: 8px;" ></a>
