...
<section class="guidebutton">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
                <a style="border:0px;border-left: 26px solid #EDD0BB;background:#774623" href="" class="btn btnguide">Exchange <br> Smartphone</a>
            </div>
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
                <a style="border:0px;border-left: 26px solid #C7F2F8;background:#1E717C" href="" class="btn active btnguide">Call<br>Now</a>
            </div>
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
                <a style="border:0px;border-left: 26px solid #CFC0ED;background:#3C1D7A" href="" class="btn btnguide">Purchase <br>& Payment</a>
            </div>
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
                <a style="border:0px;border-left: 26px solid #B3F2EB;background:#1E8176" href="" class="btn btnguide">My <br> Offers</a>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-sm-12 col-12 text-center">
              ...
              <div class="callbtn">
              <a style="border: 0px;border-left: 26px solid #B3F2EB;background: #1E8176;margin-top: 1px;margin-left: 4px;height: 46px;line-height: 43px;" href="" class="btn btnguide">Call  Now</a>
            </div>
            <p>017 260 033 24</p>
               </div>
            </div>
