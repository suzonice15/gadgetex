...
<?php } else {  ?>
    ...
    <a href="{{url('/')}}/login?url={{url('/')}}/{{$product->product_name}}" class="btn btn-success btn-sm add-to-wishlished add-to-wishlist"  data-product_id="{{ $product->product_id}}"  > <i class="fal fa-heart  me-2" style=""></i>Add to Wishlist</a>
