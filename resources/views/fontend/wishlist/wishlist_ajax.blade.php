        ...
        <table class="table table-striped table-bordered">
            ...
            @if($products)
                @foreach($products as $product)
                    ...
                    <tr>
                        <td class="name">
                            <a href="{{ url('/') }}/{{ $product->product_name }}" style="text-decoration: none;color:black">
                                <img
                                        src="{{ url('/uploads') }}/{{ $product->folder }}/thumb/{{ $product->feasured_image }}"
                                        alt="Menz full sleev polo-shirt-4327" width="80"> {{ $product->product_title }} </a></td>
                        <td class="quantity">
