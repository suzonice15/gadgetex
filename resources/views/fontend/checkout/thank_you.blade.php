...
<div class="container tank_you_print" style="background-color: white;margin-top: 10px;padding-top: 2px;">
    ...
    >
        ...
        কেনাকাটার মাধ্যম হিসেবে gadgetex – কে বেছে নেবার জন্য আপনাকে আন্তরিক ধন্যবাদ।আপনার অর্ডারটি সফলভাবে গ্রহন করা হয়েছে। এখন থেকে পরবর্তী ২৪ ঘন্টার মধ্যে আমাদের প্রতিনিধি আপনার সাথে যোগাযোগ করবেন । যে কোনো প্রয়োজনে কল করুন 01300884747
        ধন্যবাদ ।
                ...
                <div class="card panel-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-6">
                            <a tyle=" margin-left: 15px;" href="{{url('/')}}" class="btn btn-info  noprint_section d-print-none text-white">
                                <span class="fa fa-backward"></span> BACK TO HOME
                            </a>
                        </div>

                        <div class="col-md-3 col-6">
                            <button    onclick="window.print()" class="btn btn-success print noprint_section  d-print-none"
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a style="text-decoration: none;color:black" target="_blank" href="{{url('/')}}/{{$name}}"> <?= $item['name'] ?>
                                        </a>
                                        <br/>
