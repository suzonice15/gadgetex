...
<section class="campaining">
    <div style="background:#E2F4FF;border-radius:30px;" class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <img src="<?php echo e(asset('/images/ICON/ban1.png')); ?>" alt="" class="img-fluid">
                </div>
                <div class="col-lg-12">
                    <img src="<?php echo e(asset('/images/ICON/ban2.png')); ?>" alt="" class="img-fluid">
                </div>
                <div class="col-lg-12">
                    <img src="<?php echo e(asset('/images/ICON/ban3.png')); ?>" alt="" class="img-fluid">
                </div>
                <div class="col-lg-12">
                    <img src="<?php echo e(asset('/images/ICON/ban4.png')); ?>" alt="" class="img-fluid">
                </div>
                <div class="col-lg-12">
                    <img src="<?php echo e(asset('/images/ICON/ban5.png')); ?>" alt="" class="img-fluid">
                </div>
            </div>
    </div>
</section>
