...
<script>
    $(document).ready(function(){
        ...
        function fetch_data(page, query)
        {
          $.ajax({
                type:"GET",
                url:"<?php echo e(url('/admin/products/pagination')); ?>?page="+page+"&query="+query,
        ...
        $(document).on('click', '.on-off', function(){
           let productId =$(this).attr("id");
            $.ajax({
                type:"GET",
                url:"<?php echo e(url('/admin/productLocationChanged')); ?>?productId="+productId,
                success:function(data)
                {
                    location.reload();
                }
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SXampp\htdocs\gadgetex\resources\views/admin/product/index.blade.php ENDPATH**/ ?>