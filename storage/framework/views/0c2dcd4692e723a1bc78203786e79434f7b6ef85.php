...
<div class="desktop-header-top">
        ...
        <div class="nav_box">
            <div class="col-lg-3"> 
                ...
                <div  class="d-flex col-lg-4 nav_img_snd">
                     ...
                     <img style="width: 5%; height: 5%;" src="<?php echo e(url('/')); ?>/images/ICON/Call Center 1.png"   class="mt-1 img-fluid" />
        <p style="font-size: 12px;font-weight: 400;" class="ms-2 mt-1">Care | +880 1726 003 324</p>
        
        <img style="width: 5%; height: 5%;" src="<?php echo e(url('/')); ?>/images/ICON/eMail 1.png"   class="img-fluid ms-2 mt-1" />
    ...
    <div class=" last_nav_div col-lg-3">
        <img  src="<?php echo e(url('/')); ?>/images/ICON/My Offers-01 1.png"  class=" img-fluid support-picture-desktop"/>
        <a href="<?php echo e(url('/myoffer')); ?>" class="btn myoffer">My Offer</a>
        <img style="width:21px;"  src="<?php echo e(url('/')); ?>/images/ICON/Capture-4.png"  class="img-fluid"/>
        <img style="width: 81px;" src="<?php echo e(url('/')); ?>/images/ICON/Take Guide.png"  class="img-fluid " />
    </div>
