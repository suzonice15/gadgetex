        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                <div class="inner">
                    ...
                    <h4><?php echo 'Tk .' . $processing_sum; ?></h4>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                <div class="inner">
                    ...
                    <h4><?php echo 'Tk .' . $on_courier_sum; ?></h4>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            <div class="inner">
                ...
                <h4><?php echo 'Tk .' . $delivered_sum; ?></h4>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            <div class="inner">
                ...
                <h4><?php echo 'Tk .' . $completed_sum; ?></h4>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            <div class="inner">
                ...
                <h4><?php echo 'Tk .' . $today_order_sum; ?></h4>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gadgetex\resources\views/admin/layouts/dashboard.blade.php ENDPATH**/ ?>