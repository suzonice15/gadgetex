...
<div class="container-fluid mt-3">
    ...
    <img src="<?php echo e(asset('/images/ICON/Y21-10 1.png')); ?>" id="MainImg" class="img-fluid w-100 pd-5">

    <div class="product-carusal col-sm-12">
        <div> <img src="<?php echo e(asset('/images/ICON/Y21-10 1.png')); ?>" id="MainImg" class="img-fluid w-100 pd-5"></div>
        <div> <img src="<?php echo e(asset('/images/ICON/Y21-10 1.png')); ?>" id="MainImg" class="img-fluid w-100 pd-5"></div>
        <div> <img src="<?php echo e(asset('/images/ICON/Y21-10 1.png')); ?>" id="MainImg" class="img-fluid w-100 pd-5"></div>
        <div> <img src="<?php echo e(asset('/images/ICON/Y21-10 1.png')); ?>" id="MainImg" class="img-fluid w-100 pd-5"></div>
        <div> <img src="<?php echo e(asset('/images/ICON/Y21-10 1.png')); ?>" id="MainImg" class="img-fluid w-100 pd-5"></div>
...
<!-- ===============product details ============ -->
    ...
    box-shadow: 0px 0px 7px 6px rgba(221,221,221,0.98);" class="product-dtails">
        ...
        <div class=" mcompare  d-flex flex-row justify-content-around mt-2">
            ...
            <a href="" class="btn btn-success btn-sm add-to-compare" > <img class="compareicon" src="<?php echo e(asset('/images/ICON/Compare_Icon27.png')); ?>">    Compare</a>
        </div>
            ...
            <div class="row">
                <?php for($i=0;$i<4;$i++): ?>
                    <div class="col-6 mb-6 mt-3">
                        <img src="<?php echo e(asset('/images/ICON/Rectangle 1352.png')); ?>" class="img-fluid w-100" />
                    </div>
                <?php endfor; ?>
            </div>
