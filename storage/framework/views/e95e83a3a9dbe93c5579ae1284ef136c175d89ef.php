            ...
            <div style="padding:0px;" class="col-12 ">
                <div style="background:#DCDDFF;" class="offerbanar text-center p-5">
                        <div class="myoffer-title">
                            <img style="width:63px;z-index: 999;margin-left:-48px;margin-top: -20px;" src="<?php echo e(asset('/images/ICON/shopicon.png')); ?>" alt="">
...
<?php echo $__env->make('fontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gadgetex\resources\views/fontend/contact.blade.php ENDPATH**/ ?>