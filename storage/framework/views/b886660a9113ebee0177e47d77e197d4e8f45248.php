    ...
    <div class="container mt-2 px-5" style="background-color: #eef0f1;">
        <div class="row">
            <div class="col-lg-2 col-xl-2 col-xxl-2  mt-3">
                <i class="fas fa-caret-right"></i>   <?php echo $products->total(); ?> items
            ...
            <div class="col-lg-8 col-xl-8 col-xxl-8 text-center mt-3 ">
                            <?php $__currentLoopData = $bands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $band): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(url('/')); ?>/brand/<?php echo e($band->brand_link); ?>" class="btn btn-success btn-sm" style="background:white;border:none;color:black"><?php echo e($band->brand_name); ?></a>
