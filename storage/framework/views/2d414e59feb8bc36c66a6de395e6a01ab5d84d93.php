                                ...
                                <table class="table  table-bordered">
                                    ...
                                    <tr id="<?php echo e($row->id); ?>">
                                        <td>
                                            <img src="<?=$imagee?>"
                                                 width="30">
                                            <a  style="color:black;text-decoration: none" href="<?php echo e(url('/product')); ?>/<?php echo e($name); ?>"><?php echo e($row->name); ?></a>
                                        </td>
                                        <td><?=$sku?></td>
                                        <td>
                                        ...
                                        <td>      <span id="per_poduct_price">  <?php echo 'Tk ' . number_format($row->price,2); ?></span>

                                        </td>
                                        <td>
												<span id="per_poduct_total_price_181">
                                                <?php echo 'Tk ' . number_format($subTotal_price,2); ?>
                                                </span>
                                        </td>
                ...
                <div class="card-body">
                    ...
                    <div class="checkoutstep mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <span style="color:red;font-size: 18px;margin-top: -7px;position: absolute;">*</span>
                            <input required="" type="number" id="customer_phone" name="customer_phone" value="<?php echo e($customer_phone); ?>" class="form-control " placeholder="Type Your Mobile">
    ...
    jQuery('#coupon_submit').on('click', function () {
     let coupon_code=$("#coupon_code").val();
        if(coupon_code ==""){
            ...
            $.ajax({
                url:"<?php echo e(url('/')); ?>/checkCouponCode/"+coupon_code,
...
<?php echo $__env->make('fontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gadgetex\resources\views/fontend/checkout/checkout.blade.php ENDPATH**/ ?>