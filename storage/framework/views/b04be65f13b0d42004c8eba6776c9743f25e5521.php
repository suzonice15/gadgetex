...
<div class="desktop-header-top">
    <div class="main_banner_div">
        ...
        <div class="row">
            <div class="col-lg-3"> 
                <div class="logo_box" style="cursor: pointer" onclick="location.href='<?php echo e(url('/')); ?>';" >
                    <img src="<?php echo e(asset('/images/ICON/logo.svg')); ?>" class="img-fluid">
                </div>
            </div>
                <div  class="d-flex col-lg-4 nav_img_snd">

                     <img style="width: 25px;height: 23px;" src="<?php echo e(url('/')); ?>/images/ICON/Call Center 1.png"   class="mt-1 img-fluid" />
        <p style="font-size: 12px;font-weight: 400;" class="ms-2 mt-1">+880 1726 003 324</p>
        
        <img src="<?php echo e(url('/')); ?>/images/ICON/eMail 1.png"   class="img-fluid ms-2 mt-1" />
    ...
    <div class=" last_nav_div col-lg-3">
        ...
        <a href="<?php echo e(url('/')); ?>/order-tracking" class="btn trackorder"><img style="width: 24px;height: 18px;"  src="<?php echo e(url('/')); ?>/images/ICON/tracorder.png"  class=" img-fluid support-picture-desktop"/> Track Order</a>
        <a href="<?php echo e(url('/myoffer')); ?>" class="btn myoffer"> <img  src="<?php echo e(url('/')); ?>/images/ICON/My Offers-01 1.png"  class=" img-fluid support-picture-desktop"/> My Offer</a>
       
        <!-- <img style="width: 81px;" onclick="location.href='<?php echo e(url('/takeguide')); ?>';" src="<?php echo e(url('/')); ?>/images/ICON/Take Guide.png"  class="img-fluid " /> -->
        <a class="btn takeguide" onclick="location.href='<?php echo e(url('/takeguide')); ?>';"> <img   src="<?php echo e(url('/')); ?>/images/ICON/Capture-4.png"  class="img-fluid"/> Take Guide</a>
    </div>
    </div>
...
</div>  <?php /**PATH C:\xampp\htdocs\gadgetex\resources\views/fontend/partial/desktop_header_top.blade.php ENDPATH**/ ?>