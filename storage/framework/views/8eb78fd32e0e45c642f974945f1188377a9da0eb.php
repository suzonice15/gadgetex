...
<section class="guidebutton">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
                <a style="border:0px;border-left: 26px solid #FAE3E0;background:#822B1E" href="<?php echo e(url('/')); ?>/shop-address" class="btn btnguide">Shop <br>Address</a>
            </div>
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
                <a style="border:0px;border-left: 26px solid #EDD0BB;background:#774623" href="<?php echo e(url('/')); ?>/exchange-smart-phone"  class="btn btnguide">Exchange <br> Smartphone</a>
            </div>
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
            ...
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
                <a style="border:0px;border-left: 26px solid #CFC0ED;background:#3C1D7A" href="<?php echo e(url('/')); ?>/purchage-payment" class="btn btnguide">Purchase <br>& Payment</a>
            </div>
            <div class="col-lg-4 col-sm-6 col-6 takbtn text-center">
                <a style="border:0px;border-left: 26px solid #B3F2EB;background:#1E8176" href="<?php echo e(url('/')); ?>/myoffer"  class="btn btnguide">My <br> Offers</a>
            </div>
        </div>
