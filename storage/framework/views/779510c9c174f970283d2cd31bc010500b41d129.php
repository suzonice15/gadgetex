...
<?php $__env->startSection('content'); ?>
            ...
            <div class="col-12 col-lg-12 col-xl-12">
                <nav style="--bs-breadcrumb-divider: '';background: #ddd;margin-top: 9px;padding-top: 10px;padding-bottom: 1px;margin-left: 5px;padding-left: 11px;" aria-label="breadcrumb" aria-label="breadcrumb"  >
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"  style="color:black"><?php echo e($brand_row->brand_name); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-xl-12 col-xxl-12 text-center mt-5" >
              ...
              <?php $__currentLoopData = $bands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $band): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($band->brand_id==$brand_row->brand_id): ?>
                        <a href="<?php echo e(url('/')); ?>/brand/<?php echo e($band->brand_link); ?>" class="btn btn-success btn-sm" style="background: #AAF3B2;border:none;color:black"><?php echo e($band->brand_name); ?></a>
                      <?php else: ?>
                    <a href="<?php echo e(url('/')); ?>/brand/<?php echo e($band->brand_link); ?>" class="btn btn-success btn-sm" style="background: #E7E7E7;border:none;color:black"><?php echo e($band->brand_name); ?></a>
 ...
 <?php echo $__env->make('fontend.category.ajax_category', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <input type="hidden" id="category_id" value="<?php echo e($brand_row->brand_id); ?>">
...
<?php echo $__env->make('fontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gadgetex\resources\views/fontend/brand/brand.blade.php ENDPATH**/ ?>